...
export function name() {
  return 'Línea recta: pendiente - ordenada al origen a  punto - pendiente';
}
...
//-----------------------------
    ...
    const Pregunta = `
      <div class="pregunta-abierta"  data-a="${A}" data-m="${m}" style="display: none;">
        <p>${i + 1}.- Exprese la línea $${tempEcLine(m,b)}$ a la forma $y-y_0=m(x-x_0)$, donde $x_0=${A[0]}$. <span id="resultado_${i}" name="question"></span></p>
...
export async function render() {
  ...
  window.accionR2P = function(i) {
	...
	let respuesta = linea_puntopendiente(m,A)
