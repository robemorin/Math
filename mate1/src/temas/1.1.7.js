...
export function name() {
  return 'Ecuación de la línea en la forma general a partir de su gráfica';
}
...
export async function pregunta(i, totalPreguntas, esImprimible = false) {
  try {
    ...
    const Pregunta = `${i == 0 ? '<h2>Considere que en la ecuación $Ax+By+C=0$, $A>0$ y $A,B,C$ son números enteros primos relativos y $A$ es no negativo.</h2>' : ''}
