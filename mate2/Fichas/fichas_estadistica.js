    ...
    <div class="problema2">
        ...
        <ol class="FT_ol_a">
            ...
            <li>Usando sus respuestas anteriores, realice una conclusión, justifique su respuesta.<div>2</div></li>${CR(3)}
                ...
                Nombre: "Bondad de ajuste (1 renglón)",
                func: function () {
                    // Página 1: Apuntes
                    let Pregunta = `
        <div class="problema2">
        ...
        <ol class="FT_ol_a">
            ...
            <li>Compare el valor de $p$ con $\\alpha$ y verifique que coincide con la conclusión anterior.<div>2</div></li>${CR(4)}
                    ...
                    let chiCrit1 = typeof chitablas === "function" ? chitablas(3, 0.05) : 7.815;

                    let E2 = [P2_n * p_E[0], P2_n * p_E[1], P2_n * p_E[2], P2_n * p_E[3]];
                    let chiCal2 = 0;
                    for (let i = 0; i < 4; i++) chiCal2 += Math.pow(O2[i] - E2[i], 2) / E2[i];
                    let chiCrit2 = typeof chitablas === "function" ? chitablas(3, 0.05) : 7.815;
